...
| **Codex** [DONE PR #10 `8fc5800`] | Create root `README.md` per §2k in `docs/codex/PROMPTS.md` — high-level architecture + quick start + sprint progress. Single new file, 150-250 lines. | `git diff --stat main..HEAD` shows exactly 1 added file. README renders on GitHub. | DONE |
| **Claude** [DONE 2026-05-23] | Tag release `v0.2.0-s1` after Go. Update `MEMORY.md` to mark S1 complete. | `git tag` listed. | DONE |
